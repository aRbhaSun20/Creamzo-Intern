        ...
        <React.Fragment>
            <div className={style.TermsAndConditionsContainer}>
                <div className={style.LeftTerms}>
                    ...
                    <a href="#" onClick={()=>setState(1)}><p style={{marginTop:"25px"}}>Terms of service</p></a>
                    <a href="#" onClick={()=>setState(2)}><p>Privacy Policy & Cookies</p></a>
                </div>
                {state===1 && <div className={style.RightTerms}>
                    <h1 style={{ textAlign: "center", color: "black" ,fontSize:"35px",padding:"30px" }} >TERMS OF SERVICE</h1>
                    <div className={style.tos_inner}>
                        <div className={style.tos_title}>
                            <h2>Introduction</h2>
                        </div>
                        <div className={style.tos_content}>
                            <p>Welcome to Creamzo (“Company”, “we”, “our”, “us”)! These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at Creamzo.com (together or individually “Service”) operated by Creamzo. Our Privacy Policy also governs your use of our Service and explains how we collect, safeguard and disclose information that results from your use of our web pages. Your agreement with us includes these Terms and our Privacy Policy (“Agreements”). You acknowledge that you have read and understood Agreements, and agree to be bound of them. If you do not agree with (or cannot comply with) Agreements, then you may not use the Service, but please let us know by emailing at creamzo1995@gmail.com so we can try to find a solution. These Terms apply to all visitors, users and others who wish to access or use Service.</p>
                        </div>
                    </div>
                    <div className={style.tos_inner}>
                        <div className={style.tos_title}>
                        ...
                        <div className={style.tos_content}>
                            <p>By using our Service, you agree to subscribe to newsletters, marketing or promotional materials and other information we may send. However, you may opt out of receiving any, or all, of these communications from us by following the unsubscribe link or by emailing at creamzo1995@gmail.com.</p>
                        </div>
                    </div>
                    <div className={style.tos_inner}>
                        <div className={style.tos_title}>
                    ...
                    <div className={style.tos_inner}>
                        ...
                        <div className={style.tos_content}>
                            <p>Service and its original content (excluding Content provided by users), features and functionality are and will remain the exclusive property of Creamzo and its licensors. Service is protected by copyright, trademark, and other laws of and foreign countries. Our trademarks may not be used in connection with any product or service without the prior written consent of Creamzo.</p>
                    ...
                    <div className={style.tos_inner}>
                        ...
                        <div className={style.tos_content}>
                            <p>We respect the intellectual property rights of others. It is our policy to respond to any claim that Content posted on Service infringes on the copyright or other intellectual property rights (“Infringement”) of any person or entity. If you are a copyright owner, or authorized on behalf of one, and you believe that the copyrighted work has been copied in a way that constitutes copyright infringement, please submit your claim via email to creamzo1995@gmail.com, with the subject line: “Copyright Infringement” and include in your claim a detailed description of the alleged Infringement as detailed below, under “DMCA Notice and Procedure for Copyright Infringement Claims” You may be held accountable for damages (including costs and attorneys’ fees) for misrepresentation or bad-faith claims on the infringement of any Content found on and/or through Service on your copyright.</p>
                    ...
                    <div className={style.tos_inner}>
                        ...
                        <div className={style.tos_content}>
                            ...
                            <p>You can contact our Copyright Agent via email at creamzo1995@gmail.com.</p>
                        </div>
                    </div>
                    <div className={style.tos_inner}>
                        <div className={style.tos_title}>
                ...
                {state===2 && <div className={style.RightTerms}>
                    <h1 style={{ textAlign: "center", color: "black" ,fontSize:"35px",padding:"30px" }} >PRIVACY POLICY AND SERVICES</h1>
                    <div className={style.tos_inner}>
                        <div className={style.tos_title}>
                            <h2>Introduction</h2>
                        </div>
