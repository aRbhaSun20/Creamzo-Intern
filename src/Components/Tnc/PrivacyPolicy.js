	...
	return (
		<div className="tos">
			...
			<div className="tos_inner">
				...
				<div className="para">
					<p>SERVICE means the Creamzo.com website operated by Creamzo.</p>
					<p>
			...
			<div className="tos_inner">
				<div className="title">
					<h2 style={{ fontSize: "2.3rem", fontWeight: "400" }}>
						{" "}
						Personal Data
					</h2>
				</div>
			...
			<div className="tos_inner">
				<div className="title">
					<h2 style={{ fontSize: "2.3rem", fontWeight: "400" }}>Usage Data</h2>
				</div>
				<div className="para">
					<p>
			...
			<div className="tos_inner">
				<div className="title">
					<h2 style={{ fontSize: "2.3rem", fontWeight: "400" }}>Other Data</h2>
				</div>
				<div className="para">
					<p>
			...
			<div className="tos_inner">
				...
				<div className="para">
					<p>Creamzo uses the collected data for various purposes:</p>
			...
			<div className="tos_inner">
				...
				<div className="para">
					...
					<p>
						Creamzo will take all the steps reasonably necessary to ensure that
			...
			<div className="tos_inner">
				...
				<div className="para">
					...
					<p>
						...
						please send your request(s) by email: creamzo1995@gmail.com.
					</p>
					<p>
			...
			<div className="tos_inner">
				...
				<div className="para">
					<p>
						...
						us by email: creamzo1995@gmail.com.
					</p>
				</div>
			</div>
		</div>
